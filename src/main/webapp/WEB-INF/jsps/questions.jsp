...
<meta http-equiv="Content-Type" content="text/html; charset=ISO-8859-1">
        ...
        <script src="<c:url value="/resources/javascript/question.js" />" type="text/javascript" ></script>
...
<body>
    ...
    <div class="container">
        <div class="row searchbar">
            ...
            <div class="col-xs-2">
                <button id="button_add_question" class="btn btn-success col-xs-12">
        ...
        <div class="modal fade" id="modalQuestionInfo" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            ...
                            <div class="col-md-8"><p id="view_course_code"></p></div>
                        </div>
                        <div class="row">
                            <div class="col-md-4"><label>Session</label></div>
                            <div class="col-md-8"><p id="view_session"></p></div></div>
                        <div class="row">
                            <div class="col-md-4"><label>Ques type</label></div>
                            <div class="col-md-8"><p id="view_question_type"></p></div></div>
                        <div class="row">
                            <div class="col-md-4"><label></label></div>
                            <div class="col-md-8"><a id="view_question_download">download source</a></div></div>
                        <div class="row">
                            <div class="col-md-4"><label>Department</label></div>
                            <div class="col-md-8"><p id="view_question_department"></p></div></div>
                    </div>
          ...
          <div class="modal fade" id="modalQuestionEdit" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <form id="edit_question" name="edit_question" method="post" enctype="multipart/form-data">
                        <div class="modal-header">
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                            <h4 class="modal-title" id="modal_label">Add question</h4>
                        </div>
                        <div class="modal-body">
                            ...
                            <div class="row bottom-buffer">
                                <div class="col-md-4"><label>Course code</label></div>
                                <div class="col-md-8"><textarea name="courseCode" id="edit_course_code" type="text" class="form-control"></textarea></div>
                            </div>
                            <div class="row bottom-buffer">
                                <div class="col-md-4"><label>File</label></div>

                                <div class="col-md-8"><input type="file" accept=".zip" name="questionFileTest" id="edit_question_file"></input></div>
                            </div>
                        </div>
                        <div class="modal-footer">
                            <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
